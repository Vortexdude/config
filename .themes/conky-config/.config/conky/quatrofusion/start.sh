...
# Launch conky.
conky -c $HOME/.config/conky/quatrofusion/conky/cnp.conf &> /dev/null &
conky -c $HOME/.config/conky/quatrofusion/conky/date-info.conf &> /dev/null &
conky -c $HOME/.config/conky/quatrofusion/conky/weather-info.conf &> /dev/null &
